...
![GitHub stars](https://img.shields.io/github/stars/Viraj281105/ecg_fpga_accelerator?style=social)
...
├── Code/               # ML model, training pipeline, quantization, RTL test vectors
├── Documentation/      # Technical reports, architecture diagrams, design docs
├── .gitignore
├── LICENSE             # MIT License
└── README.md
```

> **Note:** The `data/` directory is not tracked in version control. See [Dataset Setup](#dataset-setup) below.
...
python Code/quantize.py

# 4. Generate test vectors for RTL simulation
python Code/generate_test_vectors.py
```
...
- [Technical Report](Documentation/reports/technical_report.pdf)
- [Model Architecture](Documentation/diagrams/model_architecture.pdf)
...
- AMD/Xilinx for FPGA tools and resources
